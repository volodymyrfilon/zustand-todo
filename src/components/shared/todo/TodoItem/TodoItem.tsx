...
export const TodoItem = ({ id, text, completed, removed }: Todo) => {
  ...
  return (
    <div
      className={`z-0 flex w-full flex-col justify-between rounded-lg bg-accent p-4 md:flex-row md:items-center ${removed ? 'text-gray-400 opacity-60' : 'text-textColor'}`}
    >
